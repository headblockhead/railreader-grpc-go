...
const file_railtypes_proto_rawDesc = "" +
	...
	"CACTIVITY_TYPE_PASSES_ANOTHER_TRAIN_AT_CROSSING_POINT_ON_SINGLE_LINE\x10#B*Z(github.com/headblockhead/railreader-grpcb\x06proto3"
