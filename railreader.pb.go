...
const file_railreader_proto_rawDesc = "" +
	"\n" +
	"\x10railreader.proto\x1a\x1cupdateLocationsRequest.proto\x1a\x1dupdateLocationsResponse.proto\x1a\x13searchRequest.proto\x1a\x14searchResponse.proto\x1a\x15describeRequest.proto\x1a\x16describeResponse.proto2\xba\x01\n" +
	"\n" +
	"RailReader\x12F\n" +
	"\x0fUpdateLocations\x12\x17.UpdateLocationsRequest\x1a\x18.UpdateLocationsResponse\"\x00\x12-\n" +
	"\x06Search\x12\x0e.SearchRequest\x1a\x0f.SearchResponse\"\x000\x01\x125\n" +
